// Login.jsx - Premium Version with Split Layout
      ...
      <div className={styles.loginContent}>
        ...
        <div className={styles.loginIllustration}>
          <div className={styles.illustrationContent}>
            <img src="/images/Blue and Pink Illustration Smart Shopping Poster.png" className={styles.featureImg} />
          </div>
          <div className={styles.illustrationDecoration}>
